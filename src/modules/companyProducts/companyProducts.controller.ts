...
export async function getCompanyProductsHandler(req: Request, res: Response, next: NextFunction) {
  try {
    const { rows } = await companyProductsRepository.getCompanyProducts();
